...
`	<?if gt $11 0
	`	<?objget :InternetGatewayDevice.WANDevice.$30.WANConnectionDevice.$20.WANIPConnection. "Name X_TWSZ-COM_ServiceList ConnectionType"
		`	G_wanConnction[m] = [];
			...
			<?objget :InternetGatewayDevice.WANDevice.$40.WANConnectionDevice.$30.WANIPConnection.$10.PortMapping. "PortMappingEnabled  PortMappingProtocol ExternalPort ExternalPortEndRange"
			`	G_PortMapping[k] = [];
				G_PortMapping[k][0] = "$01";
				G_PortMapping[k][1] = "$02";
				G_PortMapping[k][2] = "$03";
				G_PortMapping[k][3] = "$04";
				G_PortMapping[k][4] = G_wanConnction[m][1];
				k++;
			`?>
			++m;
		`?>
	...
	`	<?objget :InternetGatewayDevice.WANDevice.$30.WANConnectionDevice.$20.WANPPPConnection. "Name X_TWSZ-COM_ServiceList ConnectionType"
		`	G_wanConnction[m] = [];
			...
			G_wanConnction[m][2] = "$02";
			G_wanConnction[m][3] = "$03";
			<?objget :InternetGatewayDevice.WANDevice.$40.WANConnectionDevice.$30.WANPPPConnection.$10.PortMapping. "PortMappingEnabled PortMappingProtocol ExternalPort ExternalPortEndRange"
			`	G_PortMapping[k] = [];
				G_PortMapping[k][0] = "$01";
				G_PortMapping[k][1] = "$02";
				G_PortMapping[k][2] = "$03";

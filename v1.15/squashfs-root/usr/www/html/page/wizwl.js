...
function checkValue()
{
	...
	switch(secType)
	{
		...
		case 'Basic' :
		{
			...
			{
				alert(data_language.dynamic.Basic);
				return false;
			}
			break;
		}
		case 'WPA' :
		{
			...
			{
				alert(data_language.dynamic.WPA);
				return false;
			}
			break;
		}
		case '11i' :
		{
			...
			{
				alert(data_language.dynamic.w11i);
				return false;
			}
			break;
		}
...
function checkSSID(x)
{
	...
	if(x.charAt(0)==' ')
	{
		alert(data_language.dynamic.ssidstart);
		return false;
	}
	else if(x.charAt(x.length  -1)==' ')
	{
		alert(data_language.dynamic.sssiend);
		return false;
	}
	else if(x.indexOf('<\?') != -1 )
	{
		alert(data_language.dynamic.ssidnot);
		return false;
	}
	else if(x == '')
	{
		alert(data_language.dynamic.ssidnull);
		return false;
	}
	else if(x.indexOf('\'') != -1 )
	{

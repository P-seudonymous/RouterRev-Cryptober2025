...
function uiSubmit(){
	...
	if($('INPUT_GuestSSID_1').value.indexOf('\'') != -1 )
	{
	   alert("Error: The string of SSID1 not support contain \' ");
       return false;
	}
	if($('INPUT_GuestSSID_2').value.indexOf('\'') != -1 )
	{
	   alert("Error: The string of SSID2 not support contain \' ");
       return false;
	}
	if($('INPUT_GuestSSID_3').value.indexOf('\'') != -1 )
	{
	   alert("Error: The string of SSID3 not support contain \' ");
       return false;
	}
